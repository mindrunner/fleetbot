...
export const endMine = async (fleetInfo: FleetInfo, player: Player, mineable: Mineable): Promise<void> => {
    ...
    // await sendAndConfirmInstructions(await ixReturnsToIxs(stopMiningIx(
    //     fleetInfo,
    //     player,
    //     mineable,
    //     programs
