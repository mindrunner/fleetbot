...
export const programs: StarAtlasPrograms = {
    sage: SageProgram.buildProgram(new PublicKey(programIds.sage), anchorProvider),
    points: PointsProgram.buildProgram(new PublicKey(programIds.points), anchorProvider),
    playerProfile: PlayerProfileProgram.buildProgram(new PublicKey(programIds.profile), anchorProvider),
    cargo: CargoProgram.buildProgram(new PublicKey(programIds.cargo), anchorProvider),
    profileFaction: ProfileFactionProgram.buildProgram(new PublicKey(programIds.profileFaction), anchorProvider),
    crafting: CraftingProgram.buildProgram(new PublicKey(programIds.crafting), anchorProvider)
}
