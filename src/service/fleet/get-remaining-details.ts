...
export const getRemainFoodSec = (fleet: ShipStakingInfo, tp: number | undefined = undefined): number => {
    const timePass = tp === undefined ? getTimePass(fleet) : tp

    return fleet.foodCurrentCapacity.toNumber() - timePass
}

export const getRemainArmsSec = (fleet: ShipStakingInfo, tp: number | undefined = undefined): number => {
    const timePass = tp === undefined ? getTimePass(fleet) : tp

    return fleet.armsCurrentCapacity.toNumber() - timePass
}

export const getRemainFuelSec = (fleet: ShipStakingInfo, tp: number | undefined = undefined): number => {
    const timePass = tp === undefined ? getTimePass(fleet) : tp

    return fleet.fuelCurrentCapacity.toNumber() - timePass
}

export const getRemainHealthSec = (fleet: ShipStakingInfo, tp: number | undefined = undefined): number => {
    const timePass = tp === undefined ? getTimePass(fleet) : tp
...
export const getRemainFoodDetails =
    (shipInfo: ScoreVarsShipInfo, fleet: ShipStakingInfo, timePassSinceStart: number): Stats => {
        ...
        const burnRatePerFleet = 1 /
            ((shipInfo.millisecondsToBurnOneFood / fleet.shipQuantityInEscrow.toNumber()) / 1000)
        ...
        const maxSeconds = shipInfo.foodMaxReserve * fleet.shipQuantityInEscrow.toNumber() *
...
export const getRemainArmsDetails =
    (shipInfo: ScoreVarsShipInfo, fleet: ShipStakingInfo, timePassSinceStart: number): Stats => {
        ...
        const maxSeconds = shipInfo.armsMaxReserve * fleet.shipQuantityInEscrow.toNumber() *
        (shipInfo.millisecondsToBurnOneArms / 1000 / fleet.shipQuantityInEscrow.toNumber())
...
export const getRemainFuelDetails =
    (shipInfo: ScoreVarsShipInfo, fleet: ShipStakingInfo, timePassSinceStart: number): Stats => {
        ...
        const unitsBurnt = unitsBurnRate * timePassSinceStart * fleet.shipQuantityInEscrow.toNumber()
        const burnRatePerFleet = 1 /
            ((shipInfo.millisecondsToBurnOneFuel / fleet.shipQuantityInEscrow.toNumber()) / 1000)
        const unitsLeft = unitsBurnRate * secondsLeft * fleet.shipQuantityInEscrow.toNumber()
        ...
        fleet.shipQuantityInEscrow.toNumber() * (shipInfo.millisecondsToBurnOneFuel /
            1000 / fleet.shipQuantityInEscrow.toNumber())
...
export const getRemainHealthDetails =
    (shipInfo: ScoreVarsShipInfo, fleet: ShipStakingInfo, timePassSinceStart: number): Stats => {
        const unitsLeftPct =
        (fleet.healthCurrentCapacity.toNumber() - timePassSinceStart) / fleet.healthCurrentCapacity.toNumber()
        ...
        const burnRatePerFleet = 1 /
        ((shipInfo.millisecondsToBurnOneToolkit / fleet.shipQuantityInEscrow.toNumber()) / 1000)
        ...
        const maxSeconds = shipInfo.toolkitMaxReserve * fleet.shipQuantityInEscrow.toNumber() *
        (shipInfo.millisecondsToBurnOneToolkit / 1000 / fleet.shipQuantityInEscrow.toNumber())
...
export const getFleetRemainingResources = (shipInfo: ScoreVarsShipInfo, fleet: ShipStakingInfo): ResourceStats => {
